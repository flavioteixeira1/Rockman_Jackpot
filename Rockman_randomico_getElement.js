...
let elem = "sadgfsearfsdf";

document.getElementsByTagName("body").onload = iniciar();


function pegar_elemento_img_clicado(){
...
function pegar_elemento_aleatorio1() {
    let el = document.getElementById("aleatorio1");
    elem = el.getAttribute("src");
    alert(elem);
    //document.getElementById("oxxx").innerHTML = elem;
}
...
function parar(){
    //pegar_elemento_aleatorio1();
    //pegar_elemento_img_clicado();
    if (tentativa > 0)
    {
        n2 = 0 ;//reseta o tempo
