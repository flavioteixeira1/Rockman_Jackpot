...
var speed = 350; //velocidade de alternância dios randômicos
...
function noimageError(elemento, value){
    //fallback - image characther missing
    let fallbackDiv = document.createElement('div');
    fallbackDiv.className = 'row';
    fallbackDiv.textContent = value;
    document.getElementById(elemento).innerHTML = value
    elemento.parentNode.insertBefore(fallbackDiv, elemento)
