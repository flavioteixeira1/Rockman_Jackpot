...
var speed = 850; //tempo no intervalo da alternância dos randômicos 
...
function iniciar() {
    ...
    randomico("aleatorio1",speed,"start");
    randomico("aleatorio2",speed,"start");
    randomico("aleatorio3",speed,"start");
    randomico("aleatorio4",speed,"start");
    randomico("aleatorio5",speed,"start");
...
function showSpeed(){
    document.getElementById("b1").innerHTML = "SPEED " + speed
}
...
function aux_randomico(elemento){ //gera um número aleatorio de 0 a 10  e coloca como value da tag input
    let n1 = 0;
    ...
    // 0 DrWily; 1 cutman ; 2 gutsman; 3 elecman; 4 iceman; 5 fireman ; 6 bombman; 7 roll ; 8 Dr Light ; 9 Rockman ; 10 Rockman
    ...
    switch(n1)
    {
        case 0:
	     ...
	     document.getElementById(elemento).innerHTML = `<span style="font-size: 85px; font-weight: bold;">${0}</span>`;
            document.getElementsByName(elemento)[0].style.backgroundColor="yellow";
            break;
        case 1:
            //document.getElementById(elemento).innerHTML = 1;
	    document.getElementById(elemento).innerHTML = `<span style="font-size: 85px; font-weight: bold;">${1}</span>`;
            document.getElementsByName(elemento)[0].style.backgroundColor="red";
            break;
        case 2:
            //document.getElementById(elemento).innerHTML = 2;
	    document.getElementById(elemento).innerHTML = `<span style="font-size: 85px; font-weight: bold;">${2}</span>`;
            document.getElementsByName(elemento)[0].style.backgroundColor="green";
            break;
        case 3:
            //document.getElementById(elemento).innerHTML = 3;
	    document.getElementById(elemento).innerHTML = `<span style="font-size: 85px; font-weight: bold;">${3}</span>`;
            document.getElementsByName(elemento)[0].style.backgroundColor="brown";
            break;
        case 4:
            //document.getElementById(elemento).innerHTML = 4;
	    document.getElementById(elemento).innerHTML = `<span style="font-size: 85px; font-weight: bold;">${4}</span>`;
            document.getElementsByName(elemento)[0].style.backgroundColor="LightBlue";
            break;
        case 5:
            //document.getElementById(elemento).innerHTML = 5;
	    document.getElementById(elemento).innerHTML = `<span style="font-size: 85px; font-weight: bold;">${5}</span>`;
            document.getElementsByName(elemento)[0].style.backgroundColor="Cornsilk";
            break;
        case 6:
            //document.getElementById(elemento).innerHTML = 6;
	    document.getElementById(elemento).innerHTML = `<span style="font-size: 85px; font-weight: bold;">${6}</span>`;
            document.getElementsByName(elemento)[0].style.backgroundColor="lavanda";
            break;
        case 7:
            //document.getElementById(elemento).innerHTML = 7;
	    document.getElementById(elemento).innerHTML = `<span style="font-size: 80px; font-weight: bold;">${7}</span>`;
            document.getElementsByName(elemento)[0].style.backgroundColor="darkgray";
            break;
        case 8:
            //document.getElementById(elemento).innerHTML = 8;
	    document.getElementById(elemento).innerHTML = `<span style="font-size: 85px; font-weight: bold;">${8}</span>`;
            document.getElementsByName(elemento)[0].style.backgroundColor="Aliceblue";
            break;
        case 9:
            //document.getElementById(elemento).innerHTML = 9;
	    document.getElementById(elemento).innerHTML = `<span style="font-size: 85px; font-weight: bold;">${9}</span>`;
...
function randomico(elemento, speed, startstop) {
    ...
    if (startstop == "stop")
    {
        ...
        let numero1 = parseInt(document.getElementById(elemento).value);
    ...
    if (startstop == "start") 
    {
         if (n2 > 100){finalizar();}
            ...
            randomico1 = setInterval(function(){aux_randomico(elemento)},speed);
